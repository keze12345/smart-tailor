...
class _MainShellState extends State<MainShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final items = isTailor
      ? const [
          BottomNavigationBarItem(icon: Icon(Icons.home_outlined), activeIcon: Icon(Icons.home), label: 'Discover'),
      ...
      : const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.straighten_outlined), activeIcon: Icon(Icons.straighten), label: 'Measure'),
          BottomNavigationBarItem(icon: Icon(Icons.person_outline), activeIcon: Icon(Icons.person), label: 'Profile'),
        ];
